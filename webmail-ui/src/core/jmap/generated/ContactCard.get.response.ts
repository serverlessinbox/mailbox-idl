...
export interface ContactCardGetResponse {
  /**
   * The account the contact cards belong to.
   */
  accountId: string;
  /**
   * The current state of the ContactCard type. Pass to ContactCard/changes to detect future changes.
   */
  state: string;
  /**
   * The list of ContactCard objects that were found.
   */
  list: ContactCard[];
  /**
