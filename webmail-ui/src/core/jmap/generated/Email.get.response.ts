...
export interface EmailGetResponse {
  /**
   * The account the emails belong to.
   */
  accountId: string;
  /**
   * The current state of the Email type. Pass to Email/changes to detect future changes.
   */
  state: string;
  /**
   * The list of Email objects that were requested and found.
   */
  list: (EmailBase & {
    /**
  ...
  /**
   * IDs from the request that could not be found, or null if all were found.
   */
