...
/**
 * Response from ContactCard/copy (RFC 9610 §6.6).
 */
export interface ContactCardCopyResponse {
  ...
  accountId: string;
  /**
   * The ContactCard state in the destination account before this operation.
   */
  oldState?: string | null;
  /**
   * The ContactCard state in the destination account after this operation.
   */
  newState?: string | null;
  /**
   * Successfully copied contact cards, keyed by client creation id.
   */
  created?: {
