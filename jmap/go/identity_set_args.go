...
type IdentitySetArgs struct {
	...
	Create map[string]interface{} `json:"create,omitempty"` // Map of creation id to Identity create objects. This server does not support client-initiated creation.
