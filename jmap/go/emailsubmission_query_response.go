...
// EmailSubmissionQueryResponse Response for EmailSubmission/query (RFC 8621 §7.2 / RFC 8620 §5.5).
type EmailSubmissionQueryResponse struct {
	...
	IDs []string `json:"ids"` // The EmailSubmission ids in the requested window.
